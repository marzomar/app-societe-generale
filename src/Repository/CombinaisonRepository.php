...
/**
 * @extends ServiceEntityRepository<Combinaison>
 *
...
class CombinaisonRepository extends ServiceEntityRepository
{
    ...
    public function save(Combinaison $entity, bool $flush = false): void
    {
    ...
    public function remove(Combinaison $entity, bool $flush = false): void
    {
